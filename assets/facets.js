...
class FacetsToggle {
  constructor() {
    ...
    let closeBtn = document.querySelector(".facet-drawer-close");
    ...
    closeBtn.addEventListener("click", (e) => {
      ...
      const panel = document.querySelectorAll(".side-panel.active");
      if (panel) {
        const firstPanelElememt = panel[0]
        firstPanelElememt.classList.remove("active");
...
class FacetFiltersForm extends HTMLElement {
  ...
  static renderProductGridContainer(html) {
    const response_html = new DOMParser()
      .parseFromString(html, "text/html");

    document.getElementById("ProductGridContainer").innerHTML = response_html
      .getElementById("ProductGridContainer")
      .innerHTML;

    document.getElementById("FacetFiltersFormMobile-productcount").innerHTML = response_html
      .getElementById("FacetFiltersFormMobile-productcount").innerHTML;

    let top =
      document.getElementById("ProductGridContainer").getBoundingClientRect()
        .top +
